...
public class MainActivity extends FragmentActivity {
    ...
    private Proxy httpProxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("127.0.0.1",8118));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.test_action:
                new DownloadTaskTor().execute("http://www.google.com");
                return true;
    ...
    private class DownloadTaskTor extends AsyncTask<String, Void, String> {

        @Override
        protected String doInBackground(String... urls) {
            try {
                return loadFromNetworkTor(urls[0]);
            } catch (IOException e) {
                return getString(R.string.connection_error);
            }
        }
    ...
    /** Initiates the fetch operation. */
    private String loadFromNetworkTor(String urlString) throws IOException {
        InputStream stream = null;
        String str ="";

        try {
            stream = downloadUrlTor(urlString);
            str = readIt(stream, 500);
        } finally {
            if (stream != null) {
                stream.close();
     ...
     */
    private InputStream downloadUrlTor(String urlString) throws IOException {
